...
type SupplierServiceClient interface {
	...
	ListSupplier(ctx context.Context, in *ListSupplierRequest, opts ...grpc.CallOption) (*ListSupplierResponse, error)
	GetSupplier(ctx context.Context, in *GetSupplierRequest, opts ...grpc.CallOption) (*GetSupplierResponse, error)
	UpdateSupplie(ctx context.Context, in *UpdateSupplierRequest, opts ...grpc.CallOption) (*UpdateSupplierResponse, error)
...
func (c *supplierServiceClient) CreateSupplier(ctx context.Context, in *CreateSupplierRequest, opts ...grpc.CallOption) (*CreateSupplierResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/supplierpb.SupplierService/CreateSupplier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supplierServiceClient) ListSupplier(ctx context.Context, in *ListSupplierRequest, opts ...grpc.CallOption) (*ListSupplierResponse, error) {
	out := new(ListSupplierResponse)
	err := c.cc.Invoke(ctx, "/supplierpb.SupplierService/ListSupplier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supplierServiceClient) GetSupplier(ctx context.Context, in *GetSupplierRequest, opts ...grpc.CallOption) (*GetSupplierResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/supplierpb.SupplierService/GetSupplier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supplierServiceClient) UpdateSupplie(ctx context.Context, in *UpdateSupplierRequest, opts ...grpc.CallOption) (*UpdateSupplierResponse, error) {
	out := new(UpdateSupplierResponse)
	err := c.cc.Invoke(ctx, "/supplierpb.SupplierService/UpdateSupplie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supplierServiceClient) DeleteSupplier(ctx context.Context, in *DeleteSupplierRequest, opts ...grpc.CallOption) (*DeleteSupplierResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/supplierpb.SupplierService/DeleteSupplier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SupplierServiceServer interface {
	...
	ListSupplier(context.Context, *ListSupplierRequest) (*ListSupplierResponse, error)
	GetSupplier(context.Context, *GetSupplierRequest) (*GetSupplierResponse, error)
	UpdateSupplie(context.Context, *UpdateSupplierRequest) (*UpdateSupplierResponse, error)
...
func (UnimplementedSupplierServiceServer) ListSupplier(context.Context, *ListSupplierRequest) (*ListSupplierResponse, error) {
...
func (UnimplementedSupplierServiceServer) UpdateSupplie(context.Context, *UpdateSupplierRequest) (*UpdateSupplierResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateSupplie not implemented")
}
...
func _SupplierService_CreateSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supplierpb.SupplierService/CreateSupplier",
	}
...
func _SupplierService_ListSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supplierpb.SupplierService/ListSupplier",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SupplierService_GetSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supplierpb.SupplierService/GetSupplier",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SupplierService_UpdateSupplie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateSupplierRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupplierServiceServer).UpdateSupplie(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supplierpb.SupplierService/UpdateSupplie",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupplierServiceServer).UpdateSupplie(ctx, req.(*UpdateSupplierRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SupplierService_DeleteSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/supplierpb.SupplierService/DeleteSupplier",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SupplierService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "supplierpb.SupplierService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateSupplie",
			Handler:    _SupplierService_UpdateSupplie_Handler,
		},
		{
	...
	Metadata: "codemen.org/inventory/gunk/v1/supplier/all.proto",
}
